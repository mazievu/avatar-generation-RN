...
export const UNIVERSITY_EVENTS: GameEvent[] = [
    // 10 Main Events (with triggers)
    {
        ...
        choices: [
            { textKey: 'choice_university_first_day_1', effect: { statChanges: { iq: 2, confidence: 2 }, logKey: 'log_university_first_day_1' } },
            { textKey: 'choice_university_first_day_2', effect: { statChanges: { happiness: -2, confidence: -1 }, logKey: 'log_university_first_day_2', triggers: [{ eventId: 'university_missed_info', chance: 0.8 }] } },
            { textKey: 'choice_university_first_day_3', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_first_day_3' } },
        ]
    },
    {
    ...
    },
    {
        ...
        phases: [LifePhase.University],
        choices: [
            { textKey: 'choice_university_noisy_roommate_1', effect: { statChanges: { confidence: 1 }, logKey: 'log_university_noisy_roommate_1' } },
    ...
    },
    {
        ...
        phases: [LifePhase.University],
        choices: [
            { textKey: 'choice_university_group_presentation_1', effect: { statChanges: { iq: 2, confidence: 2 }, logKey: 'log_university_group_presentation_1' } },
            ...
            { textKey: 'choice_university_group_presentation_3', effect: { statChanges: { iq: -2, confidence: -2 }, logKey: 'log_university_group_presentation_3' } },
        ]
    },
    {
    ...
    },
    {
        ...
        choices: [
            ...
            { textKey: 'choice_university_dorm_party_3', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_dorm_party_3' } },
        ]
    },
    {
        ...
        phases: [LifePhase.University],
        choices: [
            { textKey: 'choice_university_internship_interview_1', effect: { statChanges: { confidence: 3, skill: 2 }, logKey: 'log_university_internship_interview_1' } },
            { textKey: 'choice_university_internship_interview_2', effect: { statChanges: { confidence: -3 }, logKey: 'log_university_internship_interview_2', triggers: [{ eventId: 'university_rejected_immediately', chance: 0.9 }] } },
            { textKey: 'choice_university_internship_interview_3', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_internship_interview_3' } },
        ]
    },
    {
    ...
    },
    {
        ...
        choices: [
            ...
            { textKey: 'choice_university_submit_essay_3', effect: { statChanges: { iq: -3, confidence: -2 }, logKey: 'log_university_submit_essay_3' } },
        ]
    },
    ...
    // 10 Triggered Events
    {
        ...
        choices: [
            ...
            { textKey: 'choice_university_missed_info_3', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_missed_info_3' } },
        ]
    },
    {
        ...
        choices: [
            ...
            { textKey: 'choice_university_class_full_2', effect: { statChanges: { confidence: 1 }, logKey: 'log_university_class_full_2' } },
    ...
    },
    {
        ...
        choices: [
            ...
            { textKey: 'choice_university_roommate_angry_2', effect: { statChanges: { confidence: 1 }, logKey: 'log_university_roommate_angry_2' } },
            { textKey: 'choice_university_roommate_angry_3', effect: { statChanges: { happiness: -2, confidence: -1 }, logKey: 'log_university_roommate_angry_3' } },
        ]
    },
    {
        ...
        choices: [
            ...
            { textKey: 'choice_university_group_dislikes_you_2', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_group_dislikes_you_2' } },
            { textKey: 'choice_university_group_dislikes_you_3', effect: { statChanges: { happiness: -2, confidence: -2 }, logKey: 'log_university_group_dislikes_you_3' } },
        ]
    },
    {
        ...
        isTriggerOnly: true,
        choices: [
            { textKey: 'choice_university_exam_off_topic_1', effect: { statChanges: { iq: 1, confidence: -1 }, logKey: 'log_university_exam_off_topic_1' } },
    ...
    },
    {
        ...
        isTriggerOnly: true,
        choices: [
            { textKey: 'choice_university_marked_absent_1', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_marked_absent_1' } },
            { textKey: 'choice_university_marked_absent_2', effect: { statChanges: { confidence: 1, iq: -1 }, logKey: 'log_university_marked_absent_2' } },
    ...
    },
    {
        ...
        isTriggerOnly: true,
        choices: [
            { textKey: 'choice_university_caught_by_ra_1', effect: { statChanges: { iq: -1, confidence: 1 }, logKey: 'log_university_caught_by_ra_1' } },
            { textKey: 'choice_university_caught_by_ra_2', effect: { statChanges: { happiness: -2 }, logKey: 'log_university_caught_by_ra_2' } },
            { textKey: 'choice_university_caught_by_ra_3', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_caught_by_ra_3' } },
        ]
    },
    {
        ...
        isTriggerOnly: true,
        choices: [
            { textKey: 'choice_university_rejected_immediately_1', effect: { statChanges: { confidence: 1 }, logKey: 'log_university_rejected_immediately_1' } },
            { textKey: 'choice_university_rejected_immediately_2', effect: { statChanges: { confidence: 1, happiness: -1 }, logKey: 'log_university_rejected_immediately_2' } },
            { textKey: 'choice_university_rejected_immediately_3', effect: { statChanges: { confidence: -2, happiness: -2 }, logKey: 'log_university_rejected_immediately_3' } },
        ]
    },
    {
        ...
        isTriggerOnly: true,
        choices: [
            { textKey: 'choice_university_reprimanded_by_teacher_1', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_reprimanded_by_teacher_1' } },
            { textKey: 'choice_university_reprimanded_by_teacher_2', effect: { statChanges: { iq: -1, confidence: 1 }, logKey: 'log_university_reprimanded_by_teacher_2' } },
    ...
    },
    {
        ...
        isTriggerOnly: true,
        choices: [
            { textKey: 'choice_university_points_deducted_1', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_points_deducted_1' } },
            { textKey: 'choice_university_points_deducted_2', effect: { statChanges: { iq: -1, happiness: -1 }, logKey: 'log_university_points_deducted_2' } },
            { textKey: 'choice_university_points_deducted_3', effect: { statChanges: { confidence: 1, iq: -1 }, logKey: 'log_university_points_deducted_3' } },
        ]
    },
    ...
    },
    {
        ...
        phases: [LifePhase.University],
        choices: [
            { textKey: 'choice_university_join_club_1', effect: { statChanges: { happiness: 2, confidence: 1 }, logKey: 'log_university_join_club_1' } },
    ...
    },
    {
        ...
        phases: [LifePhase.University],
        choices: [
            { textKey: 'choice_university_professor_praise_1', effect: { statChanges: { happiness: 2, confidence: 2 }, logKey: 'log_university_professor_praise_1' } },
            { textKey: 'choice_university_professor_praise_2', effect: { statChanges: { happiness: 1 }, logKey: 'log_university_professor_praise_2' } },
            { textKey: 'choice_university_professor_praise_3', effect: { statChanges: { confidence: 1 }, logKey: 'log_university_professor_praise_3' } },
        ]
    },
    {
        ...
        phases: [LifePhase.University],
        choices: [
            { textKey: 'choice_university_professor_criticism_1', effect: { statChanges: { confidence: -2 }, logKey: 'log_university_professor_criticism_1' } },
            { textKey: 'choice_university_professor_criticism_2', effect: { statChanges: { confidence: 1, iq: -1 }, logKey: 'log_university_professor_criticism_2' } },
    ...
    },
    {
        ...
        choices: [
            ...
            { textKey: 'choice_university_surprise_test_2', effect: { statChanges: { iq: -1, confidence: -1 }, logKey: 'log_university_surprise_test_2' } },
    ...
    },
    {
        ...
        phases: [LifePhase.University],
        choices: [
            { textKey: 'choice_university_club_interview_1', effect: { statChanges: { confidence: 2 }, logKey: 'log_university_club_interview_1' } },
            { textKey: 'choice_university_club_interview_2', effect: { statChanges: { confidence: 3 }, logKey: 'log_university_club_interview_2' } },
            { textKey: 'choice_university_club_interview_3', effect: { statChanges: { confidence: -2 }, logKey: 'log_university_club_interview_3' } },
        ]
    },
    {
    ...
    },
    {
        ...
        choices: [
            ...
            { textKey: 'choice_university_friends_party_2', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_friends_party_2' } },
    ...
    },
    {
        ...
        phases: [LifePhase.University],
        choices: [
            { textKey: 'choice_university_meet_professor_outside_1', effect: { statChanges: { confidence: 1 }, logKey: 'log_university_meet_professor_outside_1' } },
            { textKey: 'choice_university_meet_professor_outside_2', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_meet_professor_outside_2' } },
            { textKey: 'choice_university_meet_professor_outside_3', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_meet_professor_outside_3' } },
        ]
    },
    {
    ...
    },
    {
        ...
        phases: [LifePhase.University],
        choices: [
            { textKey: 'choice_university_first_internship_day_1', effect: { statChanges: { skill: 2, confidence: 1 }, logKey: 'log_university_first_internship_day_1' } },
            { textKey: 'choice_university_first_internship_day_2', effect: { statChanges: { confidence: -2 }, logKey: 'log_university_first_internship_day_2' } },
    ...
    },
    {
        ...
        choices: [
            ...
            { textKey: 'choice_university_exam_results_3', effect: { statChanges: { happiness: -2, confidence: -1 }, logKey: 'log_university_exam_results_3' } },
        ]
    },
    {
        ...
        choices: [
            ...
            { textKey: 'choice_university_share_food_3', effect: { statChanges: { confidence: -1 }, logKey: 'log_university_share_food_3' } },
        ]
    },
];
