export default {
    ...
    game_speed_slow: 'Slow (0.5x)',
    game_speed_normal: 'Normal (1x)',
    game_speed_fast: 'Fast (2x)',
    game_speed_very_fast: 'Very Fast (4x)',
    music_label: 'Music',
    sfx_label: 'SFX',
    ...
    path_of_life_info_title: 'Path of Life Information',
