...
export const IqIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || { width: 20, height: 20, marginRight: 4 }} viewBox="0 0 20 20" fill={color || "#60a5fa"}>
    <Path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
  </Svg>
);

export const HappinessIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || { width: 20, height: 20, marginRight: 4 }} viewBox="0 0 20 20" fill={color || "#facc15"}>
...
export const EqIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || { width: 20, height: 20, marginRight: 4 }} viewBox="0 0 20 20" fill={color || "#a78bfa"}>
...
export const HealthIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || { width: 20, height: 20, marginRight: 4 }} viewBox="0 0 20 20" fill={color || "#ef4444"}>
    <Path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
  </Svg>
);

export const SkillIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || { width: 20, height: 20, marginRight: 4 }} viewBox="0 0 20 20" fill={color || "#4ade80"}>
...
export const RobotAvatarIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg viewBox="0 0 100 100" style={style} fill={color || "currentColor"}>
