...
import { StyleProp, ViewStyle, StyleSheet, ImageSourcePropType } from 'react-native';


const iconLog: ImageSourcePropType = require('../assets/icon_log.png');
const iconAssets: ImageSourcePropType = require('../assets/icon_assets.png');
const iconFamilyTree: ImageSourcePropType = require('../assets/icon_family_tree.png');
const iconBusiness: ImageSourcePropType = require('../assets/icon_business.png');
const iconPath: ImageSourcePropType = require('../assets/icon_path.png');

export const ICONS = {
  log: iconLog,
  assets: iconAssets,
  familyTree: iconFamilyTree,
...
export const IqIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.defaultIcon} viewBox="0 0 20 20" fill={color || "#60a5fa"}>
    <Path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
  </Svg>
);

export const HappinessIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.defaultIcon} viewBox="0 0 20 20" fill={color || "#facc15"}>
...
export const EqIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.defaultIcon} viewBox="0 0 20 20" fill={color || "#a78bfa"}>
...
export const HealthIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.defaultIcon} viewBox="0 0 20 20" fill={color || "#ef4444"}>
    <Path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
  </Svg>
);

export const SkillIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.defaultIcon} viewBox="0 0 20 20" fill={color || "#4ade80"}>
    <Path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd" />
  </Svg>
);

export const MoneyIcon: React.FC<IconProps> = ({ style, color }) => (
    <Svg style={style || iconStyles.defaultIcon} viewBox="0 0 20 20" fill={color || "#4ade80"}>
...
export const MaleIcon: React.FC<IconProps> = ({ style, color }) => (
    <Svg style={style || iconStyles.genderIcon} viewBox="0 0 20 20" fill={color || "#93c5fd"}>
        <Path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
    </Svg>
);

export const FemaleIcon: React.FC<IconProps> = ({ style, color }) => (
    <Svg style={style || iconStyles.genderIcon} viewBox="0 0 20 20" fill={color || "#f9a8d4"}>
        <Path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
    </Svg>
);

export const DogIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.petIcon} viewBox="0 0 24 24" fill={color || "currentColor"}><Path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10h-3v3c0 .55-.45 1-1 1s-1-.45-1-1v-3H9c-.55 0-1-.45-1-1s.45-1 1-1h3V8c0-.55.45-1 1-1s1 .45 1 1v3h3c.55 0 1 .45 1 1s-.45 1-1 1z"/></Svg>
);
export const CatIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.petIcon} viewBox="0 0 24 24" fill={color || "currentColor"}><Path d="M4.5 15.5c2.5 0 2.5-2.5 5-2.5s2.5 2.5 5 2.5c2.5 0 2.5-2.5 5-2.5V3.14c-2.5 0-2.5 2.5-5 2.5S12 3.14 9.5 3.14c-2.5 0-2.5 2.5-5 2.5v12.36zM19.5 21c-2.5 0-2.5-2.5-5-2.5s-2.5 2.5-5 2.5-2.5-2.5-5-2.5v-2.14c2.5 0 2.5 2.5 5 2.5s2.5-2.5 5-2.5 2.5 2.5 5 2.5v2.14z"/></Svg>
);
export const ParrotIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.petIcon} viewBox="0 0 24 24" fill={color || "currentColor"}><Path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/><Path d="M12 11c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3zm0 2c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3z"/></Svg>
);
export const HorseIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.petIcon} viewBox="0 0 24 24" fill={color || "currentColor"}><Path d="M12 2.5c-4.26 0-7.75 3.49-7.75 7.75 0 1.95.73 3.73 1.94 5.12.6.7 1.54 1.13 2.56 1.13.9 0 1.73-.37 2.34-.98.6-.6.98-1.44.98-2.34 0-1.02-.45-1.92-1.17-2.56-.72-.63-1.7-1-2.75-1-1.28 0-2.4.63-3.12 1.56-.37.47-.88.75-1.44.75-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5c.31 0 .6.1.84.27.76.55 1.74.88 2.8.88 1.93 0 3.5-1.57 3.5-3.5s-1.57-3.5-3.5-3.5-3.5 1.57-3.5 3.5v.5h-2v-.5c0-3.04 2.46-5.5 5.5-5.5s5.5 2.46 5.5 5.5-2.46 5.5-5.5 5.5H11v2h1c1.38 0 2.5-1.12 2.5-2.5 0-.69-.28-1.32-.73-1.77.45-.45.73-1.08.73-1.77 0-1.38-1.12-2.5-2.5-2.5s-2.5 1.12-2.5 2.5c0 .69.28 1.32.73 1.77-.45.45-.73 1.08-.73 1.77 0 1.38 1.12 2.5 2.5 2.5h1v2h-1c-2.49 0-4.5-2.01-4.5-4.5 0-1.17.45-2.24 1.2-3.06C6.76 13.99 6.25 12.8 6.25 11.5c0-3.18 2.57-5.75 5.75-5.75S17.75 8.32 17.75 11.5c0 1.3-.51 2.49-1.34 3.34.75.84 1.2 1.91 1.2 3.06 0 2.49-2.01 4.5-4.5 4.5h-1v-2h1c1.38 0 2.5-1.12 2.5-2.5z"/></Svg>
);
export const FishIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.petIcon} viewBox="0 0 24 24" fill={color || "currentColor"}><Path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5z"/><Path d="M12 9c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></Svg>
);

export const RobotIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.defaultIcon} viewBox="0 0 20 20" fill={color || "currentColor"}>
...
export const RobotAvatarIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg viewBox="0 0 100 100" style={style || iconStyles.avatarIcon} fill={color || "currentColor"}>
...
export const UpgradeIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.defaultIcon} viewBox="0 0 20 20" fill={color || "currentColor"}>
...
export const getPetIcon = (petType: PetType): React.ReactElement | null => {
    const props = { style: iconStyles.petIcon, color: '#22d3ee' };
    switch(petType) {
...
export const LockClosedIcon: React.FC<IconProps> = ({ style, color }) => (
    <Svg style={style || iconStyles.defaultIcon} viewBox="0 0 20 20" fill={color || "currentColor"}>
...
export const CloseIcon: React.FC<IconProps> = ({ style, color }) => (
  <Svg style={style || iconStyles.defaultIcon} viewBox="0 0 24 24" fill={color || "currentColor"}>
